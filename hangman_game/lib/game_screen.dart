...
// class _GameScreenState extends State<GameScreen> {
//   var characters = "abcdefghijklmnopqrstuvwxyz".toUpperCase();
//   var word = "puppy".toUpperCase();
//   List<String> selectedChar = [];
//   var tries = 0;
//   var isWordGuessed = false; // Add this flag
//   var remainingTime = 10; // Initial time in seconds
//   var level = 1; // Initial level
//   late final ValueNotifier<int> timerNotifier; // Timer notifier
...
//         timer.cancel();
//         setState(() {
//           isWordGuessed = true; // Display the correct word
//         });
//       }
//     });
//   }
...
//   void nextLevel() {
//     // Reset game parameters for the next level
//     setState(() {
//       level++;
//       remainingTime = 10;
//       tries = 0;
...
//       startTimer();
//       // Update the word based on the level (you can define your logic)
//       word = "apple".toUpperCase();
//       // word = "orange".toUpperCase();
//     });
//   }

//   List<int> kmpPreprocess(String pattern) {
...
//     List<int> lps = kmpPreprocess(pattern);
...
//                                 isWordGuessed =
//                                     true; // Word is guessed correctly
//                                 Future.delayed(Duration(seconds: 2), () {
//                                   nextLevel(); // Move to the next level after 2 seconds
//                                 });
//                               }
//                             });
//                           },
